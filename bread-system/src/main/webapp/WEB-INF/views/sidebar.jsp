...
<div class="templatemo-sidebar">
    ...
    <nav class="templatemo-left-nav">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/goods/show"><i class="fa fa-database fa-fw"></i>面包管理</a></li>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/order/sale"><i class="fa fa-bar-chart fa-fw"></i>销售情况</a></li>
