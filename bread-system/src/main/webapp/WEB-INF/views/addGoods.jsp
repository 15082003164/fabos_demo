                ...
                <form action="${pageContext.request.contextPath}/admin/goods/addGoodsSuccess" class="templatemo-login-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        <div class="col-lg-9 form-group">
                            <label class="control-label" for="inputWithSuccess">材料1</label>
                            <input type="text" class="form-control" id="inputWithCl1" name="makings_1">
                        </div>
                        <div class="col-lg-9 form-group">
                            <label class="control-label" for="inputWithSuccess">材料2</label>
                            <input type="text" class="form-control" id="inputWithCl2" name="makings_2">
                        </div>
                        <div class="col-lg-9 form-group">
                            <label class="control-label" for="inputWithSuccess">材料3</label>
                            <input type="text" class="form-control" id="inputWithCl3" name="makings_3">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-lg-12 form-group">
