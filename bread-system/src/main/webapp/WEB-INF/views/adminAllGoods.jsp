            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="makings_1" id="makings_1">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="makings_2" class="col-sm-2 control-label">材料2</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="makings_2" id="makings_2">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="makings_3" class="col-sm-2 control-label">材料3</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="makings_3" id="makings_3">
                        </div>
                    </div>
                    <div class="form-group">
