            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="kinds_name" id="kinds_name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="kinds_num" class="col-sm-2 control-label">数量</label>
                        <div class="col-sm-9">
...
<script src="${pageContext.request.contextPath}/js/kindsManage.js"></script>
<!-- Templatemo Script -->
<script>
