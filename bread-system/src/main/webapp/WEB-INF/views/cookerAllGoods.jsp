    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <span type="text" class="form-control" name="goodsname" id="goodsname">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="num" class="col-sm-2 control-label" style="color: red">数量</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="num" name="num">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="makings_1" class="col-sm-2 control-label">材料1</label>
                        <div class="col-sm-9">
                            <span type="text" class="form-control" name="makings_1" id="makings_1">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="makings_2" class="col-sm-2 control-label">材料2</label>
                        <div class="col-sm-9">
                            <span type="text" class="form-control" name="makings_2" id="makings_2">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="makings_3" class="col-sm-2 control-label">材料3</label>
                        <div class="col-sm-9">
                            <span type="text" class="form-control" name="makings_3" id="makings_3">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="detailcate" class="col-sm-2 control-label" style="color: red">详细分类</label>
                        <div class="col-sm-9">
            ...
            <div class="modal-footer">
                <b style="color:red">可修改数量和详细分类</b>
                ...
                <div class="panel panel-default table-responsive">
                    <table id="goodsinfo" class="table table-striped table-bordered templatemo-user-table">
                        ...
                        <tr>
                            ...
                            <td><a href="" class="white-text templatemo-sort-by">材料1<span class="caret"></span></a></td>
                            <td><a href="" class="white-text templatemo-sort-by">材料2<span class="caret"></span></a></td>
                            <td><a href="" class="white-text templatemo-sort-by">材料3<span class="caret"></span></a></td>
...
<script src="${pageContext.request.contextPath}/js/cookerGoodsManage.js"></script>
<!-- Templatemo Script -->
<script>
