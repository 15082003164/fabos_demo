...
$(document).on("click",".templatemo-edit-btn",function () {
    ...
    var upGoodsMakings1 = $(this).parents("tr").find("td:eq(4)").text();
    var upGoodsMakings2 = $(this).parents("tr").find("td:eq(5)").text();
    var upGoodsMakings3 = $(this).parents("tr").find("td:eq(6)").text();
    var upGoodsDetailCate = $(this).parents("tr").find("td:eq(7)").text();
    ...
    $("#num").val(upGoodsNum);
    $("#makings_1").val(upGoodsMakings1);
    $("#makings_2").val(upGoodsMakings2);
    $("#makings_3").val(upGoodsMakings3);
...
$(document).on("click","#saveUpdate",function () {
    ...
    var unum = $("#num").val();
    var umakings1 = $("#makings_1").val();
    var umakings2 = $("#makings_2").val();
    var umakings3 = $("#makings_3").val();
...
function build_goods_table(path,result) {
    ...
    $.each(goods, function (index,item) {
        ...
        $("<tr></tr>").append(goodsid).append(goodsname).append(price).append(num).append(makings_1).append(makings_2).append(makings_3).append(detailcate).append(activityid).append(desTd).append(detailTd).append(editTd).append(deleteTd).append(actTd).appendTo("#goodsinfo tbody");
    })
}
