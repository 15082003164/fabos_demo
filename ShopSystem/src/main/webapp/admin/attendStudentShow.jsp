...
function serch()
{
   document.info.action="Admin_listAttendsStudent.action";
...
{
   document.info.action="exportAttendsStudent.action";
   document.info.submit();
}
</script>
</head>
...
<form name="info" id="info" action="Admin_listAttendsStudent.action" method="post">
