...
function serch()
{
   document.info.action="Admin_listAttendsStudentSelf.action";
...
{
   document.info.action="exportAttendsStudentSelf.action";
   document.info.submit();
}
</script>
</head>
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">考试成绩统计</span>
</div>
<form name="info" id="info" action="Admin_listAttendsStudentSelf.action" method="post">
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            姓名：
      <input type="text" id="real_name" name="real_name" value="${paramsAttend.real_name}" class="inputstyle" Style="width:155px"/>&nbsp;
            班级：
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   <tr class="listtitle">
     ...
     <td width="" align="center">出勤次数</td>
     <td width="" align="center">事假次数</td>
     <td width="" align="center">病假次数</td>
     <td width="" align="center">公假次数</td>
     <td width="" align="center">迟到次数</td>
     <td width="" align="center">早退次数</td>
     <td width="" align="center">旷课次数</td>
     <td width="" align="center">考勤分数</td>
     <td width="" align="center">是否禁考</td>
   </tr>
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">${attend.user_score}</td>  
     <td width="" align="center">${attend.user_jk}</td>  
   </tr> 
   </c:forEach>
   </c:if>
   <c:if test="${attends==null ||  fn:length(attends)==0}">
   <tr>
     <td height="60" colspan="15" align="center"><b>&lt;不存在考试成绩统计信息&gt;</b></td>
   </tr>
  </c:if>
</table>
