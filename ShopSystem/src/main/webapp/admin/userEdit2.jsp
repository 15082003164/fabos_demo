...
<title>${user!=null && user.user_id!=0?'编辑':'添加'}教师信息</title>
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">教师管理&gt;&gt;${user!=null && user.user_id!=0?'编辑':'添加'}教师</span>
</div>
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle">${user!=null && user.user_id!=0?'编辑':'添加'}教师</TD>
