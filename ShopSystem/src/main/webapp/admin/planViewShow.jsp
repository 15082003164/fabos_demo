...
function serch()
{
   document.info.action="Admin_listPlansView.action";
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">课表信息查询&gt;&gt;课表一周视图</span>
</div>
<form name="info" id="info" action="Admin_listPlansView.action" method="post">
