...
function serch()
{
   ...
   document.info.action="Admin_listAttendsClazz.action";
...
{
   document.info.action="exportAttendsClazz.action";
   document.info.submit();
}
</script>
</head>
...
<form name="info" id="info" action="Admin_listAttendsClazz.action" method="post">
