...
function del()
{
    ...
    if(confirm('确认删除吗!?'))
    {
       document.info.action="Admin_delUsers2.action?ids="+ids;
       document.info.submit();
    }
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            用户名：
      <input type="text" id="user_name" name="user_name" value="${paramsUser.user_name}" class="inputstyle" style=""/>&nbsp;
            姓名：
      <input type="text" id="real_name" name="real_name" value="${paramsUser.real_name}" class="inputstyle" style=""/>&nbsp;
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
       <img src="images/edit.png"/>&nbsp;<a href="Admin_editUser2.action?user_id=${user.user_id}">编辑</a>
     </td>
     </c:if>
   </tr> 
   </c:forEach>
   ...
   <c:if test="${users==null ||  fn:length(users)==0}">
   <tr>
     <td height="60" colspan="13" align="center"><b>&lt;不存在教师信息&gt;</b></td>
   </tr>
  </c:if>
