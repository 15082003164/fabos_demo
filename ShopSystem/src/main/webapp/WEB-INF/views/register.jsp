...
<%@ page import="com.cxxy.bysj.entity.User" %>
                ...
                <div>
                    ...
                    <form class="form-horizontal" id="form" action="${pageContext.request.contextPath}/registerresult"
                        ...
                        <div class="form-group">
                            <!-- <label for="inputName" class="col-sm-2 control-label">昵称</label> -->
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="user_parent_id"
                                       name="user_parent_id" placeholder="推荐人登录名(若无，则不填)">
                            </div>
                        </div>
