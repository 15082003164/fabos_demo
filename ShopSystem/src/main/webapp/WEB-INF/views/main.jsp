                                ...
                                <dl class="dl-hor">
                                    ...
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=手机壳">手机壳</a> <a
                                            ...
                                            href="${pageContext.request.contextPath}/category?cate=电池>电池</a> <a
                                ...
                                <dl class="dl-hor">
                                    ...
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=面膜">面膜</a> <a
                                            ...
                                            href="${pageContext.request.contextPath}/category?cate=防晒">防晒</a> <a
                                ...
                                <dl class="dl-hor">
                                    ...
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=四六级">四六级</a> <a
                                            ...
                                            href="${pageContext.request.contextPath}/category?cate=考研英语">考研英语</a>
                                    </dd>
                                </dl>
                                <dl class="dl-hor">
                                    <dt>
                                ...
                                <dl class="dl-hor">
                                    ...
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=连衣裙">连衣裙</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=半身裙"> 半身裙</a> <a
        ...
        <c:if test="${!empty digGoods}">
            ...
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${dailyGoods}" var="goods">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${goods.goodsid}"><img src="${pageContext.request.contextPath}/pictures/${goods.imagePaths[0].path}" alt=""
                                                                                                                          width="200" height="200"/>
